...
Visit Upside Down Labs `Chords Web <https://chords.upsidedownlabs.tech>`__ to visualize your bio-potential signals directly in the browser. Flash the `Chords-Arduino-Firmware <https://github.com/upsidedownlabs/chords-arduino-firmware>`_ on your board to visualize signals on Chords Web.
